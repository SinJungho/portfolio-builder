  ...
  const {
    ...
    queryFn: async () => {
      ...
      const res = await fetch(
        `/api/analytics/${activePortfolioId}/summary?period=${period}`,
      );
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] p-8 text-center space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-[#4E5968] max-w-sm">
            포트폴리오를 먼저 생성하고 홍보해 보세요. 방문자가 생기는 즉시
            통계를 확인할 수 있습니다.
          </p>
        </div>
        <Button className="rounded-full bg-[#3182F6] hover:bg-[#2162D6] px-8 h-12 font-bold shadow-lg">
          포트폴리오 생성하기
        </Button>
      </div>
    );
    ...
    <div className="p-6 sm:p-10 space-y-10 max-w-7xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 pb-2 border-b border-black/5">
        <div className="space-y-2">
          ...
          <h1 className="text-3xl sm:text-4xl font-extrabold text-[#191F28] tracking-tight">
            분석 대시보드
          </h1>
        </div>
              ...
              <CardContent className="p-8">
                <div className="flex items-start justify-between">
                  <div className="space-y-2">
                    ...
                    <h3 className="text-4xl font-extrabold text-[#191F28]">
          ...
          <Card className="rounded-[40px] border-black/5 shadow-sm overflow-hidden">
            <CardHeader className="p-8 pb-0">
              <div className="flex items-center justify-between">
                <div>
                  <CardTitle className="text-2xl font-extrabold text-[#191F28]">
                    방문자 추이
                  </CardTitle>
                ...
                {isSummaryFetching && (
                  <div className="text-[11px] font-bold text-blue-500 animate-pulse bg-blue-50 px-3 py-1 rounded-full uppercase">
                    Refreshing...
                  </div>
                )}
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <Card className="rounded-[40px] border-black/5 shadow-sm overflow-hidden">
              <CardHeader className="p-8">
                <CardTitle className="text-xl font-extrabold text-[#191F28]">
                  인기 블록 (클릭 수)
                </CardTitle>
                ...
                <div className="space-y-2">
                  {summary.topReferrers.length > 0 ? (
                    summary.topReferrers.map((ref) => (
                      <div
                        key={ref.referrer}
                        className="flex items-center justify-between p-4 rounded-2xl bg-gray-50/50 hover:bg-blue-50 transition-colors group"
                      >
